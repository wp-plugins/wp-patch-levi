...
class Yii_bloger_upload 
{
	...
	{
		include 'template/wp_upload_list.htm';
	}
	
	public function addSiteMenu() 
	{
		add_submenu_page('settings.php', '附件补丁列表', '附件补丁列表', 'manage_network_users', 'wp_upload_list', array($this, 'wpUploadList'));
	}
	
	public function addMenu() 
	{
		add_submenu_page('options-general.php', '附件补丁列表', '附件补丁列表', 'manage_options', 'wp_upload_list', array($this, 'wpUploadList'));
	}
